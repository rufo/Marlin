...
#define ENDER3_OGMC 1
#define ENDER3_CRABS 2

#define PRINTER ENDER3_OGMC
...
#define STRING_CONFIG_H_AUTHOR "(rufo, morningreis)" // Who made the changes.
...
#if PRINTER == ENDER3_OGMC
  #define CUSTOM_MACHINE_NAME "OGMC Ender-3"
#elif PRINTER == ENDER3_CRABS
  #define CUSTOM_MACHINE_NAME "CrABS Ender-3"
#endif
...
#if PRINTER == ENDER3_OGMC
  #define NOZZLE_TO_PROBE_OFFSET { -44, -14, -0 } // Adjustable Printed Mount
#elif PRINTER == ENDER3_CRABS
  #define NOZZLE_TO_PROBE_OFFSET { -43, -9, -0 } // Creality Mount
#endif
